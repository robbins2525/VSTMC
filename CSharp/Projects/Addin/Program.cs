...
internal sealed class Program : BM.AddIn
{
    ...
    protected override int Run(string[] commandLine)
    {
        ...
        ReloadEvent += OnReloadEvent;
        UnloadedEvent += OnUnloadedEvent;
    ...
    private void OnReloadEvent(BM.AddIn sender, ReloadEventArgs eventArgs)
    {
    ...
    /// <param name="eventArgs"></param>
    private void OnUnloadedEvent(BM.AddIn sender, UnloadedEventArgs eventArgs)
    {
        //TODO: add specific handling for this event here
